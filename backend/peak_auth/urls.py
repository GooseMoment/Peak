...
urlpatterns = [
    ...
    path("two_factor/totp/", views.TOTPAuthenticationView.as_view(), name="auth_two_factor"),
    path("two_factor/totp/register/", views.TOTPRegisterView.as_view(), name="new_totp"),
